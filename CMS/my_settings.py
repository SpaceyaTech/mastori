"""
Django settings for mastori project.
...
SECRET_KEY = "django-insecure-*in((^g6i2*zt*14b%6jqss17a$2yj^0b9#y6^)qxz3=qbn@i#"
...
#WSGI_APPLICATION = "mastori.wsgi.application"
